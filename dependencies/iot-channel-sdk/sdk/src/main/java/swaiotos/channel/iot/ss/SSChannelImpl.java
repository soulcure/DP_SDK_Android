...
import swaiotos.channel.iot.ss.channel.stream.IStreamChannelClient;
import swaiotos.channel.iot.ss.channel.stream.StreamChannelImpl;
...
public class SSChannelImpl implements SSChannel {
    ...
    private IStreamChannelClient mStreamChannel = new StreamChannelImpl();
    ...
    private void create(ISSChannelService service) throws Exception {
        ...
        mStreamChannel.setService(service.getStreamChannel());
    ...
    @Override
    public IStreamChannel getStreamChannel() {
